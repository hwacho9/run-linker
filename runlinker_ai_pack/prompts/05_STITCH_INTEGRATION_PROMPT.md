# AI 프롬프트 05 — Stitch 산출물 반영 (SwiftUI)

Stitch 디자인 산출물을 참조 자료로 사용해 RunLinker iOS SwiftUI 화면을 다듬어줘.
...
2. SwiftUI 구조에 맞게 유지보수 가능한 컴포넌트로 재구성
3. raw Stitch export는 별도 보존하고, SwiftUI adaptation을 분리
...
- SwiftUI 앱 구조에 맞는 재사용 가능한 컴포넌트와 화면 조합
